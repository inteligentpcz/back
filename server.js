...
const url =
  "mongodb+srv://inteligentpcz:inteligent123@cluster0.7raib3g.mongodb.net/projekt?retryWrites=true&w=majority";
...
const dbModel = mongoose.model("dbModel", dbSchema, "main");
const userModel = mongoose.model("userModel", userSchema, "users");
const Offer = mongoose.model("Offer", offerSchema, "main");
...
app.post("/removeOffer/:id", (req, res) => {
